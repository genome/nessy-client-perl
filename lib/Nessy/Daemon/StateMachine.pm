...
[ $s_aborting          , $e_shutdown , $s_fail              ,  [ \&a_abandon_last_request  , \&a_notify_abort_signal     ]                            ]                        ,
...
[ $s_registering       , $e_shutdown , $s_fail              ,  [ \&a_delete_timeout        , \&a_abandon_last_request    , \&a_notify_register_signal ]                        ]                   ,
...
[ $s_releasing         , $e_shutdown , $s_fail              ,  [ \&a_abandon_last_request  , \&a_notify_release_signal   ]                            ]                        ,
...
[ $s_withdrawing       , $e_shutdown , $s_fail              ,  [ \&a_abandon_last_request  , \&a_notify_withdraw_signal  ]                            ]                        ,
