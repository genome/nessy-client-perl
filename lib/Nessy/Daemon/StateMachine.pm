...
[ $s_aborting          , $e_signal   , $s_fail              ,  [ \&a_abandon_last_request  , \&a_notify_abort_signal     ]                            ]                        ,
...
[ $s_registering       , $e_signal   , $s_fail              ,  [ \&a_delete_timeout        , \&a_abandon_last_request    , \&a_notify_register_signal ]                        ]                   ,
...
[ $s_releasing         , $e_signal   , $s_fail              ,  [ \&a_abandon_last_request  ]                             ]                            ,
...
[ $s_retrying_abort    , $e_signal   , $s_fail              ,  [ \&a_delete_timer          ]                             ]                            ,
...
[ $s_retrying_register , $e_signal   , $s_fail              ,  [ \&a_delete_timer          , \&a_delete_timeout          ]                            ]                        ,
...
[ $s_retrying_release  , $e_signal   , $s_fail              ,  [ \&a_delete_timer          ]                             ]                            ,
...
[ $s_retrying_withdraw , $e_signal   , $s_fail              ,  [ \&a_delete_timer          ]                             ]                            ,
...
[ $s_withdrawing       , $e_signal   , $s_fail              ,  [ \&a_abandon_last_request  ]                             ]                            ,
